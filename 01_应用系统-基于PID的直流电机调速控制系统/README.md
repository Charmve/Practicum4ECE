...
> <p>对于想要获取此<b>课程设计报告word/PDF排版</b>的同学，欢迎光顾小生寒舍GitHub: https://github.com/ChromeWei/Practicum, 也可点击[``我的下载``](//download.csdn.net/download/Charmve/12038047)进行下载，但需要积分。</p>
...
# 第四部分 系统软件设计分析	
## 4.1 系统总体工作流程	
&emsp;&emsp;应用软件的编制和调试，使用 Keil 软件编程时，项目开发流程和其它软件开发项目的流程较为相似。 <br>
